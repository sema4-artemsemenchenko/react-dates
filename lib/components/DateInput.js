...
function (_ref) {
  ...
  _proto.onKeyDown = function onKeyDown(e) {
    if (e.keyCode === _constants.KEY_TAB) {
      e.preventDefault();
      return false;
    }
